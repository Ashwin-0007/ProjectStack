  ...
  return (
    <div className="h-screen bg-gray-900 text-white">
      <div className="flex h-screen bg-gray-800 rounded-lg shadow-lg overflow-hidden">
        {/* Left Section */}
        <div className="w-1/2 bg-cover bg-center p-10 flex items-center justify-center" style={{ backgroundImage: "url('images/login-background.png')" }}>
          <span>
            <span className="text-4xl font-medium text-sky-300">Register to </span>
            <div><strong className="text-amber-900 text-6xl">Project Stack</strong></div>
          </span>
        </div>
